...
var electron_1 = require("electron"); // tslint:disable-next-line:no-console
...
electron_1.ipcRenderer.on('broker', function (event, args) {
...
electron_1.ipcRenderer.on('unsubscribed', function (event, args) {
  // tslint:disable-next-line:no-console
  console.log(event, args);
});
electron_1.ipcRenderer.on('clientConnected', function (event, args) {
  // tslint:disable-next-line:no-console
  console.log(event, args);
});
electron_1.ipcRenderer.on('clientDisconnecting', function (event, args) {
  // tslint:disable-next-line:no-console
  console.log(event, args);
});
electron_1.ipcRenderer.on('clientDisconnected', function (event, args) {
  // tslint:disable-next-line:no-console
  console.log(event, args);
}); // if (connectBttn !== null) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","renderer.ts"], null)
//# sourceMappingURL=renderer.98e9290a.map